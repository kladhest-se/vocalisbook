...
///
/// Pushed rather than sheeted, like `ChapterListView` beside it — no title,
/// no on-screen dismiss button, since the remote's own Menu button is how
/// every other pushed screen in this app is left.
